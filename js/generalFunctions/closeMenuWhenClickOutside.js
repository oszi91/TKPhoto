const closeMenuWhenClickOutside = () => {
    ...
    document.addEventListener('click', e => {
        if (e.target.className !== "filters__list-item" && e.target.className !== "filters__category-list-item filters__category-list-item--color-is-checked" && e.target.className !== "filters__category-list-item") {
