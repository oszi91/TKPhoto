...
const mobileCloseMenuAfterClick = () => {
    const filtersList = document.querySelectorAll('.filters__category-list:not([data-filters-list-value="color"])>li');
    const confirmColorsBtn = document.querySelector('.filters__category-list--colors-confirm');
